...
export const CompetitorAnalysisView: React.FC<CompetitorAnalysisViewProps> = ({ data }) => {
        ...
        <div className="space-y-6">
            ...
            {activeTab === 'Summary' && (
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    {/* Opportunities */}
                    <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-lg text-white overflow-hidden relative">
            ...
            {activeTab === 'UX' && <ComparisonTable items={data.UXComparison} title="User Experience (UX)" />}
            {activeTab === 'Product' && <ComparisonTable items={data.ProductComparison} title="Product & Value" />}
            {activeTab === 'Visual' && <ComparisonTable items={data.VisualComparison} title="Visual Design & Branding" />}
            {activeTab === 'Strategy' && <ComparisonTable items={data.StrategyComparison} title="Strategic Positioning" />}
            {activeTab === 'Accessibility' && <ComparisonTable items={data.AccessibilityComparison} title="Accessibility Compliance" />}
