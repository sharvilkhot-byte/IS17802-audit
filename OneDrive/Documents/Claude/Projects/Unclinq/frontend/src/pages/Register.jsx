...
export default function Register() {
  ...
  async function handleVerifyOtp() {
    ...
    setLoading(true)
    try {
      const res = await authAPI.verifyOtp(email.trim(), otp, 'register', name.trim() || undefined)
        ...
        {step === 'email' ? (
          <>
            <div className="mb-10">
              ...
              <p className="t-body mt-2">5 minutes to set up. Everything you share stays private.</p>
            </div>

            <form onSubmit={handleSendOtp} className="space-y-4">
              <div>
                <label className="block text-text-secondary text-sm mb-2">Name (optional)</label>
                <input
                  type="text"
          ...
          <>
            <div className="mb-10">
              ...
              <p className="t-body mt-2">
                Code sent to <span style={{ color: '#C06C54' }}>{email}</span>
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                {resendCooldown > 0 ? (
                  <p className="text-sm" style={{ color: '#9B9B97' }}>Resend in {resendCooldown}s</p>
                ) : (
                  <button
